...
<div id="cars-" class="resource"><h3 class="resource-heading">Get car list <a href="#cars-" class="permalink">&nbsp;&para;</a></h3><div id="cars-get" class="action get"><h4 class="action-heading"><div class="name">Get car list</div><a href="#cars-get" class="method get">GET</a><code class="uri">/api/CMW/cars</code></h4><h4>Example URI</h4><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname"></span>/api/CMW/cars</span></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>[
    ...
    },
    {
        ...
        name: <span class="hljs-string">"Rico"</span>,
        brand: <span class="hljs-string">"CMW"</span>,
    ...
    },
    {
        ...
        name: <span class="hljs-string">"Joan"</span>,
        brand: <span class="hljs-string">"CMW"</span>,
        type: <span class="hljs-string">"Hatchback"</span>,
...
]</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="cars--1" class="resource"><h3 class="resource-heading">Get information about a specific car <a href="#cars--1" class="permalink">&nbsp;&para;</a></h3><div id="cars-get-1" class="action get"><h4 class="action-heading"><div class="name">Get information about a specific car</div><a href="#cars-get-1" class="method get">GET</a><code class="uri">/api/CMW/cars</code></h4><h4>Example URI</h4><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname"></span>/api/CMW/cars</span></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
    id: <span class="hljs-number">1</span>,
    name: <span class="hljs-string">"Kellen"</span>,
    brand: <span class="hljs-string">"CMW"</span>,
    type: <span class="hljs-string">"Hatchback"</span>,
    ...
    image: <span class="hljs-string">"http://lorempixel.com/400/200/transport/1"</span>,
    description: <span class="hljs-string">"Accusamus nihil repellat vero omnis voluptates id amet et. Suscipit qui recusandae totam nulla quam ipsam. Cupiditate sed natus debitis voluptas aut. Sit repudiandae esse perspiciatis dignissimos error. Itaque quibusdam tempora velit porro ut velit soluta. Eligendi occaecati debitis et saepe."</span>
}</code></pre><div style="height: 1px;"></div></div></div></div></div></section><section id="timeslots" class="resource-group"><h2 class="group-heading">Timeslots <a href="#timeslots" class="permalink">&para;</a></h2><p>Instructions for using the timeslots API.</p>
<div id="timeslots-" class="resource"><h3 class="resource-heading">Get timeslots list <a href="#timeslots-" class="permalink">&nbsp;&para;</a></h3><div id="timeslots-get" class="action get"><h4 class="action-heading"><div class="name">Get timeslots list</div><a href="#timeslots-get" class="method get">GET</a><code class="uri">/api/CMW/timeslots</code></h4><h4>Example URI</h4><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname"></span>/api/CMW/timeslots</span></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>[
    {
        id: <span class="hljs-number">1</span>,
        carId: <span class="hljs-number">6</span>,
        duration: <span class="hljs-number">15</span>,
        date: <span class="hljs-string">"04.05.15"</span>,
        time: <span class="hljs-string">"04:00"</span>,
    ...
    },
    {
        ...
        date: <span class="hljs-string">"03.05.15"</span>,
        time: <span class="hljs-string">"13:00"</span>,
    ...
    },
    {
        ...
        duration: <span class="hljs-number">60</span>,
        date: <span class="hljs-string">"02.05.15"</span>,
        time: <span class="hljs-string">"03:00"</span>,
...
]</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="timeslots--1" class="resource"><h3 class="resource-heading">Get information about a specific timeslot <a href="#timeslots--1" class="permalink">&nbsp;&para;</a></h3><div id="timeslots-get-1" class="action get"><h4 class="action-heading"><div class="name">Get information about a specific timeslot</div><a href="#timeslots-get-1" class="method get">GET</a><code class="uri">/api/CMW/timeslots</code></h4><h4>Example URI</h4><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname"></span>/api/CMW/timeslots</span></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
    id: <span class="hljs-number">1</span>,
    carId: <span class="hljs-number">6</span>,
    duration: <span class="hljs-number">15</span>,
    date: <span class="hljs-string">"04.05.15"</span>,
    ...
    reserved: <span class="hljs-literal">false</span>,
    contactEmail: <span class="hljs-string">"Joan.Doyle@Lynch.net"</span>
}</code></pre><div style="height: 1px;"></div></div></div></div></div></section><section id="reservations" class="resource-group"><h2 class="group-heading">Reservations <a href="#reservations" class="permalink">&para;</a></h2><div id="reservations-" class="resource"><h3 class="resource-heading">Create a new reservation <a href="#reservations-" class="permalink">&nbsp;&para;</a></h3><p>When using the reservation API, you have to supply the timeslot id as well as a valid email.</p>
<div id="reservations-post" class="action post"><h4 class="action-heading"><div class="name">Create a new reservation</div><a href="#reservations-post" class="method post">POST</a><code class="uri">/api/CMW/reservations</code></h4><h4>Example URI</h4><div class="definition"><span class="method post">POST</span>&nbsp;<span class="uri"><span class="hostname"></span>/api/CMW/reservations</span></div><div class="title"><strong>Request&nbsp;&nbsp;<code>JSON message</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Body</h5><pre><code>{
