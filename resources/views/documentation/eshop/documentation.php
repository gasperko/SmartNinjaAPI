...
]</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="products--1" class="resource"><h3 class="resource-heading">Get information about a specific product <a href="#products--1" class="permalink">&nbsp;&para;</a></h3><div id="products-get-1" class="action get"><h4 class="action-heading"><div class="name">Get information about a specific product</div><a href="#products-get-1" class="method get">GET</a><code class="uri">/api/eshop/products/{id}</code></h4><h4>Example URI</h4><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname"></span>/api/eshop/products/{id}</span></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
    id: <span class="hljs-number">1</span>,
    categoryId: <span class="hljs-number">3</span>,
    name: <span class="hljs-string">"Monty"</span>,
    color: <span class="hljs-string">"aqua"</span>,
